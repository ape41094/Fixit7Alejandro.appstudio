...
const quoteString2 = "Failure is simply the opporunity to begin again this time more intelligently." 
var lowerCaseString = secondquote.toLowerCase(); 
alert(`Lower case string is: ${lowerCaseString}`) 

var userNum = prompt("Enter a number") 
var Num = parseInt(`${userNum}`) 
var computation = Num + 10 

console.log(`The number ${Num} + 10 is ${computation}`)